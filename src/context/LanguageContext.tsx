...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'about.text': 'شركة حصص العقارية هي الاسم الرائد في تقديم المشاريع العقارية الفاخرة والمبتكرة. نسعى دائماً لصياغة معايير جديدة لجودة المعيشة والاستثمار العقاري من خلال تطوير أبراج سكنية متميزة وتوفير حلول متكاملة تتماشى مع رؤية المملكة 2030.',
    ...
    'invest.calc.roi': 'متوسط العائد السنوي المتوقع',
  ...
  en: {
    ...
    'about.text': 'HISAS Real Estate is the premier name in delivering luxury and innovative real estate developments. We constantly strive to redefine the standards of modern living and property investment by creating iconic residential towers and integrated solutions in alignment with Saudi Vision 2030.',
    ...
    'invest.calc.roi': 'Expected Average Annual Return',
