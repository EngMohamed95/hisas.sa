...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'projects.category.1': 'أبراج فردية',
    'projects.category.2': 'أبراج مجمعة',
    'projects.brand.alvera': 'ألفيرا تور (ALVERA TOWER)',
    'projects.brand.alvera.desc': 'ألفيرا تعني "الأصالة والصدق"، وهي هويتنا المخصصة لتطوير الأبراج السكنية المنفردة الفاخرة المطلة مباشرة على البحر، حيث يلتقي التصميم العصري الجريء بالتفرد المطلق.',
    'projects.brand.nexus': 'نكسيوس تور (NEXUS TOWER)',
    'projects.brand.nexus.desc': 'نكسيوس ترمز إلى "الترابط والتكامل"، وهي علامتنا الخاصة بالمجمعات العقارية المتكاملة المكونة من 2 إلى 6 أبراج تضم بيئات معيشية ذكية وخدمات مشتركة فاخرة.',
    ...
    'blog.subtitle': 'آخر أخبار حصص العقارية وتحليلات السوق العقاري السعودي',
  ...
  en: {
    ...
    'projects.category.1': 'Single Towers',
    'projects.category.2': 'Cluster Towers',
    'projects.brand.alvera': 'ALVERA TOWER',
    'projects.brand.alvera.desc': 'Alvera means "Truth and Authenticity," representing our dedicated brand for luxury stand-alone residential towers overlooking the waterfront, where bold modern architecture meets absolute exclusivity.',
    'projects.brand.nexus': 'NEXUS TOWER',
    'projects.brand.nexus.desc': 'Nexus represents "Integration and Connectivity," our dedicated brand for integrated residential complexes of 2 to 6 towers incorporating smart living environments and shared premium amenities.',
    ...
    'blog.subtitle': 'Latest updates from HISAS Real Estate and analyses of the Saudi property market',
