      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-24">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center relative z-10">
            ...
            <div className="flex flex-col items-center justify-center relative leaf-shape overflow-hidden border border-gold/30 shadow-md group aspect-[4/5] bg-slate-100 max-w-[240px] mx-auto w-full">
              <img 
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-4 p-4 bg-white leaf-shape border border-slate-200 items-start shadow-sm">
